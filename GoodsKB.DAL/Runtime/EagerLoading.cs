...
/// </summary>
/// <remarks>
/// <c>Start()</c> should be called at program start at the very beginning and <c>Stop()</c> at the end.
/// </remarks>
public static class EagerStaticConstructorsLoader
{
	/// <summary>
